...
export default function ArticlesPage() {
    ...
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Завантаження статей...</p>
        </div>
      </div>
    )
  }
  ...
  if (articles.length === 0) {
    return (
      <div className="container mx-auto px-4 py-8">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-800 mb-4">Статті</h1>
          <p className="text-gray-600">На жаль, статей поки що немає.</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-gray-800 mb-8 text-center">Освітні матеріали</h1>
      ...
      {filteredArticles.length === 0 ? (
        <div className="text-center py-8">
          <p className="text-gray-600">За вашим запитом статей не знайдено.</p>
        </div>
      ) : (
            ...
            <article key={article.id} className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow">
              <div className="p-6">
                <div className="flex justify-between items-start mb-3">
                  ...
                  <span className="text-xs text-gray-500">{article.readTime} хв читання</span>
                </div>
